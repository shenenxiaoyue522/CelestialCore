...
public class CCUtils {
    ...
    public static final ResourceLocation BYPASS_ARMOR_NAME = CelestialCore.loc("bypass_armor_attribute_name");
    public static final ResourceLocation BYPASS_TOUGHNESS_NAME = CelestialCore.loc("bypass_toughness_attribute_name");
