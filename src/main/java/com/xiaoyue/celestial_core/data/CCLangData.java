...
public enum CCLangData {
    ...
    TRANSFORMATION_RECIPE_TITLE("jei.fluid_transformation.title", "Fluid Transformation", 0);
    ...
    public static MutableComponent witherDrop(EntityType<?> type, double v) {
        ...
        boolean cleared = player != null && PlayerFlagData.hasFlag(player, CelestialFlags.NETHER_STAGE);
